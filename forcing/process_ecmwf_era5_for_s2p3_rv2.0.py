...
experiments = ['ssp370'] # note that this shoudl match exactly the experiment name used in the filename
...
directory_containing_files_to_process = '/data/BatCaveNAS/ph290/cmip6/for_s2p3/ssp370/'
output_directory = '/data/BatCaveNAS/ph290/cmip6/for_s2p3/output_processed/'+cmip_models[0]+'_ssp370/'
try:
    os.mkdir(output_directory)
except:
    pass

directory_containing_land_sea_mask_files = '/data/BatCaveNAS/ph290/cmip6/for_s2p3/output_processed/sftlf_files/'
