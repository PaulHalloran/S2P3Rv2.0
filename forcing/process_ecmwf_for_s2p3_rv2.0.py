...
domain_file = 's12_m2_s2_n2_h_map_test.dat'
...
output_directory = '/data/BatCaveNAS/ph290/ecmwf_20C/output_processed/'
...
input_variables = ['vas','uas','clt','hurs','tas','psl','wind_speed'] #these are the cmip5 names, and should all be avaiable daily NOTE WE HAVE huss not hurs... so need to convert huss to hurs/ wind speed is calculated in this script
